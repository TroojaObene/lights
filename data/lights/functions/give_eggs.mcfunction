...
#still light egg
give @p bat_spawn_egg{display:{Name:'{"text":"Movable","color":"red","bold":true}',Lore:['{"text":"The light that is placed down by this egg will be able to move","color":"dark_purple","bold":true}']},EntityTag:{id:"minecraft:marker",Rotation:[0F,-90F],Tags:["moving","placed","light"]}} 1

#still light egg
give @p bat_spawn_egg{display:{Name:'{"text":"Fill","color":"red","bold":true}',Lore:['{"text":"The light that is placed down by this egg will be fill lights","color":"dark_purple","bold":true}']},EntityTag:{id:"minecraft:marker",Rotation:[0F,-90F],Tags:["fill","placed","light"]}} 1
